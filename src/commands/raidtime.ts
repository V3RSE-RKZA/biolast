...
export const command: Command = {
	...
	aliases: ['timeleft'],
	examples: [],
	description: 'Shows how much time you have to evac when in a raid. If you are still in a raid when the time runs out, the raid will end and you will lose everything in your inventory.',
